...
# Initialize the global data embedding service
global_data_embedding_service = DataEmbeddingService(global_vector_store, global_ollama_embedder)

print("DEBUG: globals.py: Initialized global_vector_store, global_ollama_embedder, global_clustering_service, and global_data_embedding_service.")
